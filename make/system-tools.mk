...
ifeq ($(BOXTYPE), $(filter $(BOXTYPE), bre2ze4k hd51 h7 vuduo vuduo4k vuuno4kse vuzero4k vuultimo4k vuuno4k vusolo4k))
...
$(D)/vsftpd: $(D)/bootstrap $(D)/libnsl $(ARCHIVE)/$(VSFTPD_SOURCE)
	$(START_BUILD)
