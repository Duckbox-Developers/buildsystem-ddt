...
$(D)/bzip2: $(D)/bootstrap $(ARCHIVE)/$(BZIP2_SOURCE)
	...
	$(CHDIR)/bzip2-$(BZIP2_VER); \
		...
		$(MAKE) install PREFIX=$(TARGET_DIR)/usr
ifneq ($(BOXTYPE), $(filter $(BOXTYPE), bre2ze4k hd51 h7 vuduo vuduo4k vuuno4kse vuzero4k vuultimo4k vuuno4k vusolo4k))
