...
ifeq ($(BS_GCC_VER), 11.1.0)
CROSSTOOL_GCC_VER = gcc-11.1.0
endif

ifeq ($(BS_GCC_VER), 12.0.0)
CROSSTOOL_GCC_VER = gcc-12.0.0
endif
...
ifeq ($(BS_GCC_VER), $(filter $(BS_GCC_VER), 10.3.0 11.1.0 12.0.0))
