...
ifeq ($(BOXTYPE), $(filter $(BOXTYPE), vuduo4k vuduo4kse vuuno4kse vuultimo4k vusolo4k dm800se dm8000 dm7020hd dm820 dm7080 dm900 dm920 e4hdultra vuduo2 vuultimo))
TOOLS += $(D)/tools-oled_ctrl
endif
ifeq ($(BOXTYPE), $(filter $(BOXTYPE), dm800 dm800sev2 dm8000 dm7020hd dm7080))
